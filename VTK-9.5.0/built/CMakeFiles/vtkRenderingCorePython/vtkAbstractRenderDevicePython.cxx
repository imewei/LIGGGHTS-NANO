...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkAbstractRenderDevice(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkAbstractRenderDevice_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkAbstractRenderDevice_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("requested_gl_version"),
    /*get=*/nullptr,
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkAbstractRenderDevice_SetRequestedGLVersion(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkAbstractRenderDevice_SetRequestedGLVersion(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("write-only, Calls SetRequestedGLVersion\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkAbstractRenderDevice_ClassNew()
{
 ...
 &PyvtkAbstractRenderDevice_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkAbstractRenderDevice_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
