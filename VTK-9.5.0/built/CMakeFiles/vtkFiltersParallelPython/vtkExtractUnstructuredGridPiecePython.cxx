...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkExtractUnstructuredGridPiece(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkExtractUnstructuredGridPiece_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkExtractUnstructuredGridPiece_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkExtractUnstructuredGridPiece_GetCreateGhostCells(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkExtractUnstructuredGridPiece_SetCreateGhostCells(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkExtractUnstructuredGridPiece_SetCreateGhostCells(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkExtractUnstructuredGridPiece_ClassNew()
{
 ...
 &PyvtkExtractUnstructuredGridPiece_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkExtractUnstructuredGridPiece_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
