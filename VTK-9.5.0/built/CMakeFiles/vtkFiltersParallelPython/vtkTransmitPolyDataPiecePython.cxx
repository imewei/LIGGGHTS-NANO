...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkTransmitPolyDataPiece(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkTransmitPolyDataPiece_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkTransmitPolyDataPiece_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkTransmitPolyDataPiece_GetController(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkTransmitPolyDataPiece_SetController(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkTransmitPolyDataPiece_SetController(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkTransmitPolyDataPiece_GetCreateGhostCells(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkTransmitPolyDataPiece_SetCreateGhostCells(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkTransmitPolyDataPiece_SetCreateGhostCells(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkTransmitPolyDataPiece_ClassNew()
{
 ...
 &PyvtkTransmitPolyDataPiece_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkTransmitPolyDataPiece_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
