...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkAbstractPolyDataReader(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkAbstractPolyDataReader_ClassNew(); }
...
static PyObject *
PyvtkAbstractPolyDataReader_SetStream(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp0, "vtkResourceStream"))
  {
    ...
    {
      op->vtkAbstractPolyDataReader::SetStream(temp0);
    }
...
static PyObject *
PyvtkAbstractPolyDataReader_GetStream(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkResourceStream *tempr = (ap.IsBound() ?
      op->GetStream() :
      op->vtkAbstractPolyDataReader::GetStream());
...
static PyMethodDef PyvtkAbstractPolyDataReader_Methods[] = {
  ...
  {"SetFileName", PyvtkAbstractPolyDataReader_SetFileName, METH_VARARGS,
   "SetFileName(self, _arg:str) -> None\nC++: virtual void SetFileName(const char *_arg)\n\nSpecify file name of AbstractPolyData file (obj / off / ply /\nstl).\n"},
  {"GetFileName", PyvtkAbstractPolyDataReader_GetFileName, METH_VARARGS,
   "GetFileName(self) -> str\nC++: virtual char *GetFileName()\n\n"},
  {"SetStream", PyvtkAbstractPolyDataReader_SetStream, METH_VARARGS,
   "SetStream(self, _arg:vtkResourceStream) -> None\nC++: virtual void SetStream(vtkResourceStream *_arg)\n\nSpecify stream to read from When both `Stream` and `Filename` are\nset, it's left to the implementation to determine which one is\nused. If both are null, reader outputs nothing.\n"},
  {"GetStream", PyvtkAbstractPolyDataReader_GetStream, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkAbstractPolyDataReader_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkAbstractPolyDataReader_GetFileName(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkAbstractPolyDataReader_SetFileName(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkAbstractPolyDataReader_SetFileName(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkAbstractPolyDataReader_GetStream(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkAbstractPolyDataReader_SetStream(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkAbstractPolyDataReader_SetStream(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkAbstractPolyDataReader_ClassNew()
{
 ...
 nullptr);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkAbstractPolyDataReader_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
