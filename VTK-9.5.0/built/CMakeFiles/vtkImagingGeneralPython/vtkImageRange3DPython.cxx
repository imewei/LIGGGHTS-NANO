...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkImageRange3D(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkImageRange3D_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkImageRange3D_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkImageRange3D_SetKernelSize(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkImageRange3D_SetKernelSize(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkImageRange3D_ClassNew()
{
 ...
 &PyvtkImageRange3D_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkImageRange3D_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
