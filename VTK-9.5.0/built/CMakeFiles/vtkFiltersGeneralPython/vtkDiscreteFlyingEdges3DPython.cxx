...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDiscreteFlyingEdges3D(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDiscreteFlyingEdges3D_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkDiscreteFlyingEdges3D_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDiscreteFlyingEdges3D_GetComputeNormals(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeNormals(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeNormals(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetComputeGradients(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeGradients(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeGradients(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetComputeScalars(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeScalars(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetComputeScalars(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetInterpolateAttributes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetInterpolateAttributes(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetInterpolateAttributes(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetArrayComponent(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetArrayComponent(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetArrayComponent(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetMTime(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetValues(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDiscreteFlyingEdges3D_GetNumberOfContours(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkDiscreteFlyingEdges3D_SetNumberOfContours(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkDiscreteFlyingEdges3D_SetNumberOfContours(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkDiscreteFlyingEdges3D_ClassNew()
{
 ...
 &PyvtkDiscreteFlyingEdges3D_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDiscreteFlyingEdges3D_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
