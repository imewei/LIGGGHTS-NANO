...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkNormalizeMatrixVectors(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkNormalizeMatrixVectors_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkNormalizeMatrixVectors_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkNormalizeMatrixVectors_GetVectorDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkNormalizeMatrixVectors_SetVectorDimension(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkNormalizeMatrixVectors_SetVectorDimension(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkNormalizeMatrixVectors_GetPValue(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkNormalizeMatrixVectors_SetPValue(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkNormalizeMatrixVectors_SetPValue(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetPValue/SetPValue\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkNormalizeMatrixVectors_ClassNew()
{
 ...
 &PyvtkNormalizeMatrixVectors_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkNormalizeMatrixVectors_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
