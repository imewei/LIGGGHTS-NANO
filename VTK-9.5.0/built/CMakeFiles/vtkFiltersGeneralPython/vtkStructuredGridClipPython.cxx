...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkStructuredGridClip(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkStructuredGridClip_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkStructuredGridClip_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkStructuredGridClip_SetOutputWholeExtent(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkStructuredGridClip_SetOutputWholeExtent(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkStructuredGridClip_GetClipData(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkStructuredGridClip_SetClipData(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkStructuredGridClip_SetClipData(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkStructuredGridClip_ClassNew()
{
 ...
 &PyvtkStructuredGridClip_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkStructuredGridClip_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
