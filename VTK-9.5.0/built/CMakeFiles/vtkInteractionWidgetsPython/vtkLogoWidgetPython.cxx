...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkLogoWidget(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkLogoWidget_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkLogoWidget_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkLogoWidget_SetRepresentation(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkLogoWidget_SetRepresentation(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkLogoWidget_ClassNew()
{
 ...
 &PyvtkLogoWidget_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkLogoWidget_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
