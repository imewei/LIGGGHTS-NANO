...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkTensorProbeWidget(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkTensorProbeWidget_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkTensorProbeWidget_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkTensorProbeWidget_SetRepresentation(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkTensorProbeWidget_SetRepresentation(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  {
    /*name=*/pystr("tensor_probe_representation"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkTensorProbeWidget_GetTensorProbeRepresentation(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
    /*doc=*/pystr("read-only, Calls GetTensorProbeRepresentation\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkTensorProbeWidget_ClassNew()
{
 ...
 &PyvtkTensorProbeWidget_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkTensorProbeWidget_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
