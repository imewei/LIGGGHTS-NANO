...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkImageTranslateExtent(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkImageTranslateExtent_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkImageTranslateExtent_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkImageTranslateExtent_GetTranslation(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkImageTranslateExtent_SetTranslation(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkImageTranslateExtent_SetTranslation(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkImageTranslateExtent_ClassNew()
{
 ...
 &PyvtkImageTranslateExtent_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkImageTranslateExtent_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
