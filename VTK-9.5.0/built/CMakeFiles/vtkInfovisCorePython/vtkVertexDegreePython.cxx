...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkVertexDegree(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkVertexDegree_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkVertexDegree_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkVertexDegree_SetOutputArrayName(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkVertexDegree_SetOutputArrayName(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkVertexDegree_ClassNew()
{
 ...
 &PyvtkVertexDegree_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkVertexDegree_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
