...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkGroupLeafVertices(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkGroupLeafVertices_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkGroupLeafVertices_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("group_domain"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkGroupLeafVertices_GetGroupDomain(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkGroupLeafVertices_SetGroupDomain(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkGroupLeafVertices_SetGroupDomain(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetGroupDomain/SetGroupDomain\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkGroupLeafVertices_ClassNew()
{
 ...
 &PyvtkGroupLeafVertices_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkGroupLeafVertices_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
