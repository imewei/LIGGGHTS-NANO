...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkMergeColumns(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkMergeColumns_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkMergeColumns_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("merged_column_name"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkMergeColumns_GetMergedColumnName(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkMergeColumns_SetMergedColumnName(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkMergeColumns_SetMergedColumnName(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetMergedColumnName/SetMergedColumnName\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkMergeColumns_ClassNew()
{
 ...
 &PyvtkMergeColumns_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkMergeColumns_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
