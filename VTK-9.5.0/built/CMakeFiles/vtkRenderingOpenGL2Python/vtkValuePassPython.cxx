...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkValuePass(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkValuePass_ClassNew(); }
...
template<class T>
static PyObject *PyvtkValuePass_Mode_FromEnum(T val)
{
...
#endif
static PyGetSetDef PyvtkValuePass_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkValuePass_SetInputArrayToProcess(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkValuePass_SetInputArrayToProcess(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  {
    /*name=*/pystr("input_component_to_process"),
    /*get=*/nullptr,
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkValuePass_SetInputComponentToProcess(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkValuePass_SetInputComponentToProcess(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("write-only, Calls SetInputComponentToProcess\n"),
    /*closure=*/nullptr,
  },
  {
    /*name=*/pystr("float_image_extents"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkValuePass_GetFloatImageExtents(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
    /*doc=*/pystr("read-only, Calls GetFloatImageExtents\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkValuePass_ClassNew()
{
 ...
 &PyvtkValuePass_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkValuePass_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
