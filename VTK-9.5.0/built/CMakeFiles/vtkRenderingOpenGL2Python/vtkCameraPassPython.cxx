...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkCameraPass(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkCameraPass_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkCameraPass_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("delegate_pass"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkCameraPass_GetDelegatePass(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkCameraPass_SetDelegatePass(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkCameraPass_SetDelegatePass(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetDelegatePass/SetDelegatePass\n"),
    /*closure=*/nullptr,
  },
  {
    /*name=*/pystr("aspect_ratio_override"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkCameraPass_GetAspectRatioOverride(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkCameraPass_SetAspectRatioOverride(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkCameraPass_SetAspectRatioOverride(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetAspectRatioOverride/SetAspectRatioOverride\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkCameraPass_ClassNew()
{
 ...
 &PyvtkCameraPass_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkCameraPass_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
