...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkOpenGLLabeledContourMapper(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkOpenGLLabeledContourMapper_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkOpenGLLabeledContourMapper_GetSets[] = {
...
PyObject *PyvtkOpenGLLabeledContourMapper_ClassNew()
{
 ...
 &PyvtkOpenGLLabeledContourMapper_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkOpenGLLabeledContourMapper_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
