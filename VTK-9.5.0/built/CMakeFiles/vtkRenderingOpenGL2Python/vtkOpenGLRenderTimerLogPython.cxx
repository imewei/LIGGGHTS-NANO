...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkOpenGLRenderTimerLog(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkOpenGLRenderTimerLog_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkOpenGLRenderTimerLog_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("min_timer_pool_size"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkOpenGLRenderTimerLog_GetMinTimerPoolSize(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkOpenGLRenderTimerLog_SetMinTimerPoolSize(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkOpenGLRenderTimerLog_SetMinTimerPoolSize(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetMinTimerPoolSize/SetMinTimerPoolSize\n"),
    /*closure=*/nullptr,
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkOpenGLRenderTimerLog_GetLoggingEnabled(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
    /*doc=*/pystr("read-only, Calls GetLoggingEnabled\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkOpenGLRenderTimerLog_ClassNew()
{
 ...
 &PyvtkOpenGLRenderTimerLog_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkOpenGLRenderTimerLog_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
