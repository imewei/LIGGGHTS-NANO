...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkImageProcessingPass(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkImageProcessingPass_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkImageProcessingPass_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkImageProcessingPass_GetDelegatePass(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkImageProcessingPass_SetDelegatePass(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkImageProcessingPass_SetDelegatePass(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkImageProcessingPass_ClassNew()
{
 ...
 nullptr);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkImageProcessingPass_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
