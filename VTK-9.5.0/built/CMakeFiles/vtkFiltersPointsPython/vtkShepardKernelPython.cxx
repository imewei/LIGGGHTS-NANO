...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkShepardKernel(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkShepardKernel_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkShepardKernel_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkShepardKernel_GetPowerParameter(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkShepardKernel_SetPowerParameter(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkShepardKernel_SetPowerParameter(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkShepardKernel_ClassNew()
{
 ...
 &PyvtkShepardKernel_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkShepardKernel_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
