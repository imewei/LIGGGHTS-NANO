...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkExtractPointCloudPiece(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkExtractPointCloudPiece_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkExtractPointCloudPiece_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("modulo_ordering"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkExtractPointCloudPiece_GetModuloOrdering(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkExtractPointCloudPiece_SetModuloOrdering(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkExtractPointCloudPiece_SetModuloOrdering(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetModuloOrdering/SetModuloOrdering\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkExtractPointCloudPiece_ClassNew()
{
 ...
 &PyvtkExtractPointCloudPiece_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkExtractPointCloudPiece_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
