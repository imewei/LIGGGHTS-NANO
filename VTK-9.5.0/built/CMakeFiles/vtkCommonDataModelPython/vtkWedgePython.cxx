...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkWedge(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkWedge_ClassNew(); }
...
static PyObject *
PyvtkWedge_TriangulateLocalIds(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp1, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkWedge::TriangulateLocalIds(temp0, temp1));
...
static PyMethodDef PyvtkWedge_Methods[] = {
  ...
  {"TriangulateLocalIds", PyvtkWedge_TriangulateLocalIds, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkWedge_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkWedge_GetCellType(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkWedge_GetCellDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkWedge_GetParametricCoords(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkWedge_ClassNew()
{
 ...
 &PyvtkWedge_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkWedge_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
