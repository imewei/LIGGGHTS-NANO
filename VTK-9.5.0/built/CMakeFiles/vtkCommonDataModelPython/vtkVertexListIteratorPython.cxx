...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkVertexListIterator(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkVertexListIterator_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkVertexListIterator_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkVertexListIterator_GetGraph(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkVertexListIterator_SetGraph(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkVertexListIterator_SetGraph(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkVertexListIterator_ClassNew()
{
 ...
 &PyvtkVertexListIterator_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkVertexListIterator_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
