...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkTetra(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkTetra_ClassNew(); }
...
static PyObject *
PyvtkTetra_TriangulateLocalIds(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp1, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTetra::TriangulateLocalIds(temp0, temp1));
...
static PyMethodDef PyvtkTetra_Methods[] = {
  ...
  {"TriangulateLocalIds", PyvtkTetra_TriangulateLocalIds, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkTetra_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkTetra_GetCellType(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkTetra_GetParametricCoords(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkTetra_ClassNew()
{
 ...
 &PyvtkTetra_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkTetra_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
