...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkTimePointUtility(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkTimePointUtility_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkTimePointUtility_GetSets[] = {
...
PyObject *PyvtkTimePointUtility_ClassNew()
{
 ...
 &PyvtkTimePointUtility_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkTimePointUtility_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
