...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkGaussianCubeReader2(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkGaussianCubeReader2_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkGaussianCubeReader2_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkGaussianCubeReader2_GetOutput(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkGaussianCubeReader2_SetOutput(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkGaussianCubeReader2_SetOutput(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkGaussianCubeReader2_GetFileName(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkGaussianCubeReader2_SetFileName(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkGaussianCubeReader2_SetFileName(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkGaussianCubeReader2_GetGridOutput(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkGaussianCubeReader2_ClassNew()
{
 ...
 &PyvtkGaussianCubeReader2_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkGaussianCubeReader2_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
