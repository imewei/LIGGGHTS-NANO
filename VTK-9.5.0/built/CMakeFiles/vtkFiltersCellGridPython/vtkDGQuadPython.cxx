...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGQuad(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGQuad_ClassNew(); }
...
static PyObject *
PyvtkDGQuad_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkDGQuad::IsTypeOf(temp0);
...
static PyObject *
PyvtkDGQuad_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGQuad *op = static_cast<vtkDGQuad *>(vp);
...
static PyObject *
PyvtkDGQuad_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkDGQuad *tempr = vtkDGQuad::SafeDownCast(temp0);
...
static PyObject *
PyvtkDGQuad_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkDGQuad *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDGQuad::NewInstance());
...
static PyObject *
PyvtkDGQuad_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDGQuad::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDGQuad_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkDGQuad_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGQuad_GetDimension(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkDGQuad_GetNumberOfSideTypes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetNumberOfSideTypes());
...
static PyObject *
PyvtkDGQuad_GetNumberOfSidesOfDimension(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetNumberOfSidesOfDimension(temp0));
...
static PyObject *
PyvtkDGQuad_GetSideConnectivity_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGQuad::GetSideConnectivity(temp0));
...
static PyObject *
PyvtkDGQuad_GetSideConnectivity_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetSideConnectivity");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGQuad *op = static_cast<vtkDGQuad *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetSideConnectivity());
...
static PyObject *
PyvtkDGQuad_GetSideConnectivity(PyObject *self, PyObject *args)
{
  ...
  {
    case 1:
      return PyvtkDGQuad_GetSideConnectivity_s1(self, args);
    case 0:
      return PyvtkDGQuad_GetSideConnectivity_s2(self, args);
  }
...
static PyObject *
PyvtkDGQuad_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGQuad::GetSidesOfSide(temp0));
...
static PyObject *
PyvtkDGQuad_GetReferencePoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeFloat32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetReferencePoints());
...
static PyObject *
PyvtkDGQuad_GetSideOffsetsAndShapes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGQuad::GetSideOffsetsAndShapes());
...
static PyMethodDef PyvtkDGQuad_Methods[] = {
  {"IsTypeOf", PyvtkDGQuad_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkDGQuad_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkDGQuad_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDGQuad\nC++: static vtkDGQuad *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDGQuad_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDGQuad\nC++: vtkDGQuad *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDGQuad_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDGQuad_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsInside", PyvtkDGQuad_IsInside, METH_VARARGS,
  ...
  {"GetDimension", PyvtkDGQuad_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of this cell type (0, 1, 2, or\n3).\n"},
  {"GetNumberOfSideTypes", PyvtkDGQuad_GetNumberOfSideTypes, METH_VARARGS,
  ...
  {"GetNumberOfSidesOfDimension", PyvtkDGQuad_GetNumberOfSidesOfDimension, METH_VARARGS,
  ...
  {"GetSideConnectivity", PyvtkDGQuad_GetSideConnectivity, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGQuad_GetSidesOfSide, METH_VARARGS,
  ...
  {"GetReferencePoints", PyvtkDGQuad_GetReferencePoints, METH_VARARGS,
  ...
  {"GetSideOffsetsAndShapes", PyvtkDGQuad_GetSideOffsetsAndShapes, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGQuad_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGQuad_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGQuad_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGQuad_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGQuad_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGQuad_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
static const char *PyvtkDGQuad_Doc =
  "vtkDGQuad - Metadata for a discontinuous Galerkin quadrilateral.\n\n"
...
static PyTypeObject PyvtkDGQuad_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCellGrid.vtkDGQuad", // tp_name
...
static vtkObjectBase *PyvtkDGQuad_StaticNew()
{
  return vtkDGQuad::New();
}

PyObject *PyvtkDGQuad_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkDGQuad_Type, PyvtkDGQuad_Methods,
    "vtkDGQuad",
 &PyvtkDGQuad_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGQuad_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}

void PyVTKAddFile_vtkDGQuad(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkDGQuad_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkDGQuad", o) != 0)
  {
    Py_DECREF(o);
  }
