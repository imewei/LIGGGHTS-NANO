...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGBoundsResponder(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGBoundsResponder_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkDGBoundsResponder_GetSets[] = {
...
PyObject *PyvtkDGBoundsResponder_ClassNew()
{
 ...
 &PyvtkDGBoundsResponder_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGBoundsResponder_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
