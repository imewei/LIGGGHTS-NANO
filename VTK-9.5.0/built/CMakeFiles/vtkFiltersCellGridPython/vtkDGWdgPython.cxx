...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGWdg(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGWdg_ClassNew(); }
...
static PyObject *
PyvtkDGWdg_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkDGWdg::IsTypeOf(temp0);
...
static PyObject *
PyvtkDGWdg_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGWdg *op = static_cast<vtkDGWdg *>(vp);
...
static PyObject *
PyvtkDGWdg_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkDGWdg *tempr = vtkDGWdg::SafeDownCast(temp0);
...
static PyObject *
PyvtkDGWdg_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkDGWdg *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDGWdg::NewInstance());
...
static PyObject *
PyvtkDGWdg_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDGWdg::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDGWdg_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkDGWdg_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGWdg_GetDimension(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkDGWdg_GetNumberOfSideTypes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetNumberOfSideTypes());
...
static PyObject *
PyvtkDGWdg_GetNumberOfSidesOfDimension(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetNumberOfSidesOfDimension(temp0));
...
static PyObject *
PyvtkDGWdg_GetSideConnectivity_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGWdg::GetSideConnectivity(temp0));
...
static PyObject *
PyvtkDGWdg_GetSideConnectivity_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetSideConnectivity");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGWdg *op = static_cast<vtkDGWdg *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetSideConnectivity());
...
static PyObject *
PyvtkDGWdg_GetSideConnectivity(PyObject *self, PyObject *args)
{
  ...
  {
    case 1:
      return PyvtkDGWdg_GetSideConnectivity_s1(self, args);
    case 0:
      return PyvtkDGWdg_GetSideConnectivity_s2(self, args);
  }
...
static PyObject *
PyvtkDGWdg_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGWdg::GetSidesOfSide(temp0));
...
static PyObject *
PyvtkDGWdg_GetReferencePoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeFloat32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetReferencePoints());
...
static PyObject *
PyvtkDGWdg_GetSideOffsetsAndShapes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGWdg::GetSideOffsetsAndShapes());
...
static PyMethodDef PyvtkDGWdg_Methods[] = {
  {"IsTypeOf", PyvtkDGWdg_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkDGWdg_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkDGWdg_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDGWdg\nC++: static vtkDGWdg *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDGWdg_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDGWdg\nC++: vtkDGWdg *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDGWdg_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDGWdg_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsInside", PyvtkDGWdg_IsInside, METH_VARARGS,
  ...
  {"GetDimension", PyvtkDGWdg_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of this cell type (0, 1, 2, or\n3).\n"},
  {"GetNumberOfSideTypes", PyvtkDGWdg_GetNumberOfSideTypes, METH_VARARGS,
  ...
  {"GetNumberOfSidesOfDimension", PyvtkDGWdg_GetNumberOfSidesOfDimension, METH_VARARGS,
  ...
  {"GetSideConnectivity", PyvtkDGWdg_GetSideConnectivity, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGWdg_GetSidesOfSide, METH_VARARGS,
  ...
  {"GetReferencePoints", PyvtkDGWdg_GetReferencePoints, METH_VARARGS,
  ...
  {"GetSideOffsetsAndShapes", PyvtkDGWdg_GetSideOffsetsAndShapes, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGWdg_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGWdg_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGWdg_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGWdg_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGWdg_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGWdg_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
static const char *PyvtkDGWdg_Doc =
  "vtkDGWdg - Metadata for a discontinuous Galerkin wedge.\n\n"
...
static PyTypeObject PyvtkDGWdg_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCellGrid.vtkDGWdg", // tp_name
...
static vtkObjectBase *PyvtkDGWdg_StaticNew()
{
  return vtkDGWdg::New();
}

PyObject *PyvtkDGWdg_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkDGWdg_Type, PyvtkDGWdg_Methods,
    "vtkDGWdg",
 &PyvtkDGWdg_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGWdg_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}

void PyVTKAddFile_vtkDGWdg(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkDGWdg_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkDGWdg", o) != 0)
  {
    Py_DECREF(o);
  }
