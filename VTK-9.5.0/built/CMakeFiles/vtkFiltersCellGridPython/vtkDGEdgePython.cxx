...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGEdge(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGEdge_ClassNew(); }
...
static PyObject *
PyvtkDGEdge_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkDGEdge::IsTypeOf(temp0);
...
static PyObject *
PyvtkDGEdge_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGEdge *op = static_cast<vtkDGEdge *>(vp);
...
static PyObject *
PyvtkDGEdge_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkDGEdge *tempr = vtkDGEdge::SafeDownCast(temp0);
...
static PyObject *
PyvtkDGEdge_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkDGEdge *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDGEdge::NewInstance());
...
static PyObject *
PyvtkDGEdge_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDGEdge::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDGEdge_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkDGEdge_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGEdge_GetDimension(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkDGEdge_GetNumberOfSideTypes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetNumberOfSideTypes());
...
static PyObject *
PyvtkDGEdge_GetNumberOfSidesOfDimension(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetNumberOfSidesOfDimension(temp0));
...
static PyObject *
PyvtkDGEdge_GetSideConnectivity_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGEdge::GetSideConnectivity(temp0));
...
static PyObject *
PyvtkDGEdge_GetSideConnectivity_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetSideConnectivity");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGEdge *op = static_cast<vtkDGEdge *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetSideConnectivity());
...
static PyObject *
PyvtkDGEdge_GetSideConnectivity(PyObject *self, PyObject *args)
{
  ...
  {
    case 1:
      return PyvtkDGEdge_GetSideConnectivity_s1(self, args);
    case 0:
      return PyvtkDGEdge_GetSideConnectivity_s2(self, args);
  }
...
static PyObject *
PyvtkDGEdge_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGEdge::GetSidesOfSide(temp0));
...
static PyObject *
PyvtkDGEdge_GetReferencePoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeFloat32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetReferencePoints());
...
static PyObject *
PyvtkDGEdge_GetSideOffsetsAndShapes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGEdge::GetSideOffsetsAndShapes());
...
static PyMethodDef PyvtkDGEdge_Methods[] = {
  {"IsTypeOf", PyvtkDGEdge_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkDGEdge_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkDGEdge_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDGEdge\nC++: static vtkDGEdge *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDGEdge_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDGEdge\nC++: vtkDGEdge *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDGEdge_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDGEdge_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsInside", PyvtkDGEdge_IsInside, METH_VARARGS,
  ...
  {"GetDimension", PyvtkDGEdge_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of this cell type (0, 1, 2, or\n3).\n"},
  {"GetNumberOfSideTypes", PyvtkDGEdge_GetNumberOfSideTypes, METH_VARARGS,
  ...
  {"GetNumberOfSidesOfDimension", PyvtkDGEdge_GetNumberOfSidesOfDimension, METH_VARARGS,
  ...
  {"GetSideConnectivity", PyvtkDGEdge_GetSideConnectivity, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGEdge_GetSidesOfSide, METH_VARARGS,
  ...
  {"GetReferencePoints", PyvtkDGEdge_GetReferencePoints, METH_VARARGS,
  ...
  {"GetSideOffsetsAndShapes", PyvtkDGEdge_GetSideOffsetsAndShapes, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGEdge_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGEdge_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGEdge_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGEdge_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGEdge_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGEdge_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
static const char *PyvtkDGEdge_Doc =
  "vtkDGEdge - Metadata for a discontinuous Galerkin triangle.\n\n"
...
static PyTypeObject PyvtkDGEdge_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCellGrid.vtkDGEdge", // tp_name
...
static vtkObjectBase *PyvtkDGEdge_StaticNew()
{
  return vtkDGEdge::New();
}

PyObject *PyvtkDGEdge_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkDGEdge_Type, PyvtkDGEdge_Methods,
    "vtkDGEdge",
 &PyvtkDGEdge_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGEdge_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}

void PyVTKAddFile_vtkDGEdge(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkDGEdge_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkDGEdge", o) != 0)
  {
    Py_DECREF(o);
  }
