...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGPyr(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGPyr_ClassNew(); }
...
static PyObject *
PyvtkDGPyr_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkDGPyr::IsTypeOf(temp0);
...
static PyObject *
PyvtkDGPyr_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGPyr *op = static_cast<vtkDGPyr *>(vp);
...
static PyObject *
PyvtkDGPyr_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkDGPyr *tempr = vtkDGPyr::SafeDownCast(temp0);
...
static PyObject *
PyvtkDGPyr_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkDGPyr *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDGPyr::NewInstance());
...
static PyObject *
PyvtkDGPyr_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDGPyr::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDGPyr_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkDGPyr_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGPyr_GetDimension(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkDGPyr_GetNumberOfSideTypes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetNumberOfSideTypes());
...
static PyObject *
PyvtkDGPyr_GetNumberOfSidesOfDimension(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetNumberOfSidesOfDimension(temp0));
...
static PyObject *
PyvtkDGPyr_GetSideConnectivity_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGPyr::GetSideConnectivity(temp0));
...
static PyObject *
PyvtkDGPyr_GetSideConnectivity_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetSideConnectivity");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGPyr *op = static_cast<vtkDGPyr *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetSideConnectivity());
...
static PyObject *
PyvtkDGPyr_GetSideConnectivity(PyObject *self, PyObject *args)
{
  ...
  {
    case 1:
      return PyvtkDGPyr_GetSideConnectivity_s1(self, args);
    case 0:
      return PyvtkDGPyr_GetSideConnectivity_s2(self, args);
  }
...
static PyObject *
PyvtkDGPyr_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGPyr::GetSidesOfSide(temp0));
...
static PyObject *
PyvtkDGPyr_GetReferencePoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeFloat32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetReferencePoints());
...
static PyObject *
PyvtkDGPyr_GetSideOffsetsAndShapes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGPyr::GetSideOffsetsAndShapes());
...
static PyMethodDef PyvtkDGPyr_Methods[] = {
  {"IsTypeOf", PyvtkDGPyr_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkDGPyr_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkDGPyr_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDGPyr\nC++: static vtkDGPyr *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDGPyr_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDGPyr\nC++: vtkDGPyr *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDGPyr_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDGPyr_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsInside", PyvtkDGPyr_IsInside, METH_VARARGS,
  ...
  {"GetDimension", PyvtkDGPyr_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of this cell type (0, 1, 2, or\n3).\n"},
  {"GetNumberOfSideTypes", PyvtkDGPyr_GetNumberOfSideTypes, METH_VARARGS,
  ...
  {"GetNumberOfSidesOfDimension", PyvtkDGPyr_GetNumberOfSidesOfDimension, METH_VARARGS,
  ...
  {"GetSideConnectivity", PyvtkDGPyr_GetSideConnectivity, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGPyr_GetSidesOfSide, METH_VARARGS,
  ...
  {"GetReferencePoints", PyvtkDGPyr_GetReferencePoints, METH_VARARGS,
  ...
  {"GetSideOffsetsAndShapes", PyvtkDGPyr_GetSideOffsetsAndShapes, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGPyr_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGPyr_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGPyr_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGPyr_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGPyr_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGPyr_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
static const char *PyvtkDGPyr_Doc =
  "vtkDGPyr - Metadata for a discontinuous Galerkin pyramid.\n\n"
...
static PyTypeObject PyvtkDGPyr_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCellGrid.vtkDGPyr", // tp_name
...
static vtkObjectBase *PyvtkDGPyr_StaticNew()
{
  return vtkDGPyr::New();
}

PyObject *PyvtkDGPyr_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkDGPyr_Type, PyvtkDGPyr_Methods,
    "vtkDGPyr",
 &PyvtkDGPyr_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGPyr_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}

void PyVTKAddFile_vtkDGPyr(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkDGPyr_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkDGPyr", o) != 0)
  {
    Py_DECREF(o);
  }
