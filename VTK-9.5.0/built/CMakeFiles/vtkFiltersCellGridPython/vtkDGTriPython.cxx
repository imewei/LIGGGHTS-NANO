...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGTri(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGTri_ClassNew(); }
...
static PyObject *
PyvtkDGTri_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkDGTri::IsTypeOf(temp0);
...
static PyObject *
PyvtkDGTri_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGTri *op = static_cast<vtkDGTri *>(vp);
...
static PyObject *
PyvtkDGTri_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkDGTri *tempr = vtkDGTri::SafeDownCast(temp0);
...
static PyObject *
PyvtkDGTri_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkDGTri *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDGTri::NewInstance());
...
static PyObject *
PyvtkDGTri_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDGTri::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDGTri_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkDGTri_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGTri_GetDimension(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkDGTri_GetNumberOfSideTypes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetNumberOfSideTypes());
...
static PyObject *
PyvtkDGTri_GetNumberOfSidesOfDimension(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetNumberOfSidesOfDimension(temp0));
...
static PyObject *
PyvtkDGTri_GetSideConnectivity_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGTri::GetSideConnectivity(temp0));
...
static PyObject *
PyvtkDGTri_GetSideConnectivity_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetSideConnectivity");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDGTri *op = static_cast<vtkDGTri *>(vp);
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetSideConnectivity());
...
static PyObject *
PyvtkDGTri_GetSideConnectivity(PyObject *self, PyObject *args)
{
  ...
  {
    case 1:
      return PyvtkDGTri_GetSideConnectivity_s1(self, args);
    case 0:
      return PyvtkDGTri_GetSideConnectivity_s2(self, args);
  }
...
static PyObject *
PyvtkDGTri_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGTri::GetSidesOfSide(temp0));
...
static PyObject *
PyvtkDGTri_GetReferencePoints(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeFloat32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetReferencePoints());
...
static PyObject *
PyvtkDGTri_GetSideOffsetsAndShapes(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkTypeInt32Array *tempr = (ap.IsBound() ?
      ...
      op->vtkDGTri::GetSideOffsetsAndShapes());
...
static PyMethodDef PyvtkDGTri_Methods[] = {
  {"IsTypeOf", PyvtkDGTri_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkDGTri_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkDGTri_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDGTri\nC++: static vtkDGTri *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDGTri_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDGTri\nC++: vtkDGTri *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDGTri_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDGTri_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsInside", PyvtkDGTri_IsInside, METH_VARARGS,
  ...
  {"GetDimension", PyvtkDGTri_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of this cell type (0, 1, 2, or\n3).\n"},
  {"GetNumberOfSideTypes", PyvtkDGTri_GetNumberOfSideTypes, METH_VARARGS,
  ...
  {"GetNumberOfSidesOfDimension", PyvtkDGTri_GetNumberOfSidesOfDimension, METH_VARARGS,
  ...
  {"GetSideConnectivity", PyvtkDGTri_GetSideConnectivity, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGTri_GetSidesOfSide, METH_VARARGS,
  ...
  {"GetReferencePoints", PyvtkDGTri_GetReferencePoints, METH_VARARGS,
  ...
  {"GetSideOffsetsAndShapes", PyvtkDGTri_GetSideOffsetsAndShapes, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGTri_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGTri_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTri_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTri_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTri_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTri_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
static const char *PyvtkDGTri_Doc =
  "vtkDGTri - Metadata for a discontinuous Galerkin triangle.\n\n"
...
static PyTypeObject PyvtkDGTri_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCellGrid.vtkDGTri", // tp_name
...
static vtkObjectBase *PyvtkDGTri_StaticNew()
{
  return vtkDGTri::New();
}

PyObject *PyvtkDGTri_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkDGTri_Type, PyvtkDGTri_Methods,
    "vtkDGTri",
 &PyvtkDGTri_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGTri_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}

void PyVTKAddFile_vtkDGTri(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkDGTri_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkDGTri", o) != 0)
  {
    Py_DECREF(o);
  }
