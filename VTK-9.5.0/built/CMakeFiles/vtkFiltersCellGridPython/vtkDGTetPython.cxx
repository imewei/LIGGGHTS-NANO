...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkDGTet(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkDGTet_ClassNew(); }
...
static PyObject *
PyvtkDGTet_IsInside(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkDGTet::IsInside(*temp0, temp1));
...
static PyObject *
PyvtkDGTet_GetSidesOfSide(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    const std::vector<long long> *tempr = (ap.IsBound() ?
      ...
      &op->vtkDGTet::GetSidesOfSide(temp0));
...
static PyMethodDef PyvtkDGTet_Methods[] = {
  ...
  {"IsInside", PyvtkDGTet_IsInside, METH_VARARGS,
  ...
  {"GetSidesOfSide", PyvtkDGTet_GetSidesOfSide, METH_VARARGS,
...
#endif
static PyGetSetDef PyvtkDGTet_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkDGTet_GetDimension(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTet_GetReferencePoints(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTet_GetSideConnectivity(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTet_GetSideOffsetsAndShapes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
  ...
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkDGTet_GetNumberOfSideTypes(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkDGTet_ClassNew()
{
 ...
 &PyvtkDGTet_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkDGTet_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
