...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkXMLPartitionedDataSetReader(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkXMLPartitionedDataSetReader_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkXMLPartitionedDataSetReader_GetSets[] = {
...
PyObject *PyvtkXMLPartitionedDataSetReader_ClassNew()
{
 ...
 &PyvtkXMLPartitionedDataSetReader_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkXMLPartitionedDataSetReader_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
