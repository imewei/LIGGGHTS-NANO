...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkCompositeDataSetAlgorithm(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkCompositeDataSetAlgorithm_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkCompositeDataSetAlgorithm_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkCompositeDataSetAlgorithm_SetInputData(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkCompositeDataSetAlgorithm_SetInputData(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkCompositeDataSetAlgorithm_GetOutput(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkCompositeDataSetAlgorithm_ClassNew()
{
 ...
 &PyvtkCompositeDataSetAlgorithm_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkCompositeDataSetAlgorithm_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
