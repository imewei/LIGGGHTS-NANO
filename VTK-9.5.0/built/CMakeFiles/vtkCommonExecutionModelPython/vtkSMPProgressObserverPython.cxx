...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkSMPProgressObserver(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkSMPProgressObserver_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkSMPProgressObserver_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("local_observer"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkSMPProgressObserver_GetLocalObserver(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
    /*doc=*/pystr("read-only, Calls GetLocalObserver\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkSMPProgressObserver_ClassNew()
{
 ...
 &PyvtkSMPProgressObserver_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkSMPProgressObserver_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
