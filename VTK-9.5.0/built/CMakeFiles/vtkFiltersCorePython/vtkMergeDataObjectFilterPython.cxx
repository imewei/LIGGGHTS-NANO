...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkMergeDataObjectFilter(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkMergeDataObjectFilter_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkMergeDataObjectFilter_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("data_object_input_data"),
    /*get=*/nullptr,
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkMergeDataObjectFilter_SetDataObjectInputData(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkMergeDataObjectFilter_SetDataObjectInputData(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("write-only, Calls SetDataObjectInputData\n"),
    /*closure=*/nullptr,
  },
  {
    /*name=*/pystr("output_field"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkMergeDataObjectFilter_GetOutputField(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkMergeDataObjectFilter_SetOutputField(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkMergeDataObjectFilter_SetOutputField(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetOutputField/SetOutputField\n"),
    /*closure=*/nullptr,
  },
  {
    ...
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkMergeDataObjectFilter_GetDataObject(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/nullptr,
...
PyObject *PyvtkMergeDataObjectFilter_ClassNew()
{
 ...
 &PyvtkMergeDataObjectFilter_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkMergeDataObjectFilter_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
