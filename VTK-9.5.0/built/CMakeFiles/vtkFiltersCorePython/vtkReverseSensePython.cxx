...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkReverseSense(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkReverseSense_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkReverseSense_GetSets[] = {
  PyVTKObject_GetSet[0],
  PyVTKObject_GetSet[1],
  {
    /*name=*/pystr("reverse_cells"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkReverseSense_GetReverseCells(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkReverseSense_SetReverseCells(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkReverseSense_SetReverseCells(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetReverseCells/SetReverseCells\n"),
    /*closure=*/nullptr,
  },
  {
    /*name=*/pystr("reverse_normals"),
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      auto args = PyTuple_New(0); // placeholder
      auto result = PyvtkReverseSense_GetReverseNormals(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkReverseSense_SetReverseNormals(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkReverseSense_SetReverseNormals(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
    /*doc=*/pystr("read-write, Calls GetReverseNormals/SetReverseNormals\n"),
    /*closure=*/nullptr,
  },
...
PyObject *PyvtkReverseSense_ClassNew()
{
 ...
 &PyvtkReverseSense_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkReverseSense_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
