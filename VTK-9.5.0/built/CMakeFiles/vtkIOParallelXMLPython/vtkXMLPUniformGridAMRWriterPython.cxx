...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkXMLPUniformGridAMRWriter(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkXMLPUniformGridAMRWriter_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkXMLPUniformGridAMRWriter_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkXMLPUniformGridAMRWriter_GetController(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkXMLPUniformGridAMRWriter_SetController(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkXMLPUniformGridAMRWriter_SetController(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
  ...
  },
  {
    ...
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      if (PyTuple_Check(value))
      {
        auto result = PyvtkXMLPUniformGridAMRWriter_SetWriteMetaFile(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkXMLPUniformGridAMRWriter_SetWriteMetaFile(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkXMLPUniformGridAMRWriter_ClassNew()
{
 ...
 &PyvtkXMLPUniformGridAMRWriter_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkXMLPUniformGridAMRWriter_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
