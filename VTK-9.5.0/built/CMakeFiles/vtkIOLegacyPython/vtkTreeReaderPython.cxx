...
extern "C" { VTK_ABI_HIDDEN void PyVTKAddFile_vtkTreeReader(PyObject *dict); }
extern "C" { VTK_ABI_HIDDEN PyObject *PyvtkTreeReader_ClassNew(); }
...
#endif
static PyGetSetDef PyvtkTreeReader_GetSets[] = {
  ...
  PyVTKObject_GetSet[1],
  {
    ...
    /*get=*/[](PyObject* self, void*) -> PyObject*
    {
      ...
      auto result = PyvtkTreeReader_GetOutput(self, args);
      Py_DECREF(args);
      return result;
    },
    /*set=*/[](PyObject* self, PyObject* value, void*) -> int
    {
      ...
      {
        auto result = PyvtkTreeReader_SetOutput(self, value);
        return (result == nullptr) ? -1 : 0;
      }
      else
      {
        auto args = PyTuple_Pack(1, value);
        auto result = PyvtkTreeReader_SetOutput(self, args);
        Py_DECREF(args);
        return (result == nullptr) ? -1 : 0;
      }
    },
...
PyObject *PyvtkTreeReader_ClassNew()
{
 ...
 &PyvtkTreeReader_StaticNew);
  ...
  PyVTKClass_AddCombinedGetSetDefinitions(pytype, PyvtkTreeReader_GetSets);
  PyType_Ready(pytype);
  return (PyObject *)pytype;
}
